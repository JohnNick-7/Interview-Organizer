...
public class LoginCandidate extends AppCompatActivity {
            ...
            auth.signInWithEmailAndPassword(em,pa).addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                ...
                public void onComplete(@NonNull Task<AuthResult> task) {
                    if(task.isSuccessful())
                    {
                        ...
                        sendUser();
                        Toast.makeText(LoginCandidate.this, "Logged in Successfully", Toast.LENGTH_SHORT).show();
                    }
                    else
                    {
                        progressDialog.dismiss();
                        Toast.makeText(LoginCandidate.this,"Invalid credentials",Toast.LENGTH_SHORT).show();
                    }
                }
            });
